...
def test_llm_fallback_on_gpt_failure():
    ...
    """
    fallback_text = "Հնարավոր չէ ստանալ տվյալներ «Breaking Bad» սերիալի մասին այս պահին։"

    with patch("app.llm.series_picker.client.chat.completions.create", side_effect=Exception("GPT 500 error")):
