...
@pytest.mark.parametrize("series_name, mocked_response, expected_keywords", [
    (
        "Breaking Bad",
...
def test_llm_output_regression(series_name, mocked_response, expected_keywords):
    ...
    """
    with patch("app.llm.series_picker.get_series_details_by_name_llm", return_value=mocked_response):
